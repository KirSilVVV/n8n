-- 004_agent_settings.sql
-- Mutable per-agent settings: prompt, model, whitelist, schedule, budget
-- Schema: ai

CREATE TABLE IF NOT EXISTS ai.agent_settings (
...
INSERT INTO ai.agent_settings (agent_name, model, budget_usd_month, schedule_cron) VALUES
...
COMMENT ON TABLE ai.agent_settings IS
  'Per-agent runtime settings. Editable via panel without redeploy.';
